...
title: v8.6.0 Initialization Control - Dynamsoft Barcode Reader JavaScript Edition API
description: This page shows the Initialization Control of the BarcodeReader Class of Dynamsoft Barcode Reader JavaScript SDK.
keywords: BarcodeReader, api reference, javascript, js
needAutoGenerateSidebar: true
needGenerateH3Content: true
noTitleIndex: true
breadcrumbText: BarcodeReader
permalink: /programming/javascript/api-reference/InitializationControl-v8.6.0.html
---
