...
- UNPKG  
  ...
  ```html
  <script src="https://unpkg.com/dynamsoft-javascript-barcode@9.6.32/dist/dbr.js"></script>
  ```
...
To test the SDK, you can request a 30-day trial license via the <a href="https://www.dynamsoft.com/customer/license/trialLicense?ver=9.6.32&utm_source=guide&product=dbr&package=js" target="_blank">Request a Trial License</a> link.
