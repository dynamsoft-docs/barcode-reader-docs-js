...
<div class="filetree">
    ...
    <div class="children">
            ...
            <div class="file"><a data-balloon-length="xlarge" data-balloon-pos="down" aria-label="Decode video stream in an Angular
                Application from a USB-connected or built-in camera (mobile or desktop)." class="button title"
                    ...
                    Angular (<img alt="Angular logo"
                        ...
                        <span id="icon003" class="tooltipIcon"></span></div>
            <div class="file"><a data-balloon-length="xlarge" data-balloon-pos="down" aria-label="Decode video stream in a React
                Application from a USB-connected or built-in camera (mobile or desktop)." class="button title"
                    ...
                    React (<img alt="React logo"
                        ...
                        <span id="icon004" class="tooltipIcon"></span></div>
        ...
        <div class="children">
            <div class="file"><a data-balloon-length="xlarge" data-balloon-pos="down" aria-label="Show the default camera UI to decode video stream
        ...
        <div class="children">
            ...
            <div class="file"><a data-balloon-length="xlarge" data-balloon-pos="down"
                    ...
                    class="button title"  href="parameter-settings.html#set-deblur-modes-and-scale-up-modes">Deblur Modes and Scale-up Modes</a><span id="icon014" class="tooltipIcon"></span></div>
            <div class="file"><a data-balloon-length="xlarge" data-balloon-pos="down"
                    aria-label="Set DeformationResistingModes or BarcodeComplementModes for decoding deformed or incomplete barcodes."
                    class="button title"  href="parameter-settings.html#deformation-resisting-modes-and-barcode-complement-modes">Deformation Resisting and Barcode Complementing</a><span id="icon015" class="tooltipIcon"></span></div>
            <div class="file"><a data-balloon-length="xlarge" data-balloon-pos="down"
                    aria-label="Set the region of interest manually or regionPredetectionModes to speed up the reading process."
                    class="button title"  href="parameter-settings.html#define-or-detect-the-region-of-interest">Define or Detect the Region of Interest</a><span id="icon016" class="tooltipIcon"></span></div>
        </div>
